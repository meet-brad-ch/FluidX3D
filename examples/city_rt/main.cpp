...
void main_setup() { // city real-time interactive; required extensions in defines.hpp: FP16S, EQUILIBRIUM_BOUNDARIES, SUBGRID, INTERACTIVE_GRAPHICS
	// ################################################################## define simulation box size, viscosity and volume force ###################################################################
	const uint L = 512u; // simulation box resolution (can be adjusted: 256u for faster, 1024u for higher quality)
	...
	lbm.run(); // interactive mode - use mouse to rotate camera, press P to pause/unpause
} /**/
